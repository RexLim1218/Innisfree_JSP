 ...
 * @author Rex Lim
 */
@WebServlet(name = "activeCustomer", urlPatterns = {"/activeCustomer"})
public class activeCustomer extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (row > 0) {
            ...
            jsonResponse.put("message", "Customer: ' " + custName + " ' Active Successfully!!!");
        } else {
            jsonResponse.put("status", "error");
            jsonResponse.put("message", "Customer: ' " + custName + " ' Active UnSuccessfully!!!");
        }
        response.setContentType("application/json");
