<%-- 
    Document   : promotion
    Created on : May 5, 2023, 9:23:02 PM
    Author     : yokec
--%>
                                        ...
                                        <div class="collection-product-wrapper">
                                            ...
                                            <div class="product-wrapper-grid">
                                                <div class="row margin-res">
                                                    <%
                                                        try {
                                                            String sql1 = "SELECT * FROM PRODUCTLIST WHERE DISCOUNT > 0 AND PROD_STATUS = 'Active' AND ISDELETED =FALSE";
                                            ...
                                            <div class="product-pagination">
                                                <div class="theme-paggination-block">
                                                    <%
                                                        try {
                                                            String sql1 = "SELECT COUNT(*) as total FROM PRODUCTLIST WHERE DISCOUNT > 0 AND PROD_STATUS = 'Active'";
                                                            Statement stmt1 = conn.createStatement();
                                                            ResultSet rs = stmt1.executeQuery(sql1);
                                                            if (rs.next()) {
                                                    %>
