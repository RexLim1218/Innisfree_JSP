<%-- 
    Document   : allproductlist
    Created on : May 6, 2023, 3:16:55 PM
    Author     : yokec
--%>
                                        ...
                                        <div class="collection-product-wrapper">
                                            ...
                                            <div class="product-wrapper-grid">
                                                <div class="row margin-res">
                                                    <%
                                                        try {
                                                            String sql1 = "SELECT * FROM PRODUCTLIST WHERE PROD_STATUS = 'Active' AND ISDELETED = FALSE";
                                            ...
                                            <div class="product-pagination">
                                                <div class="theme-paggination-block">
                                                    <%
                                                        try {
                                                            String sql1 = "SELECT COUNT(*) as total FROM PRODUCTLIST WHERE PROD_STATUS = 'Active'";
                                                            Statement stmt1 = conn.createStatement();
                                                            ResultSet rs = stmt1.executeQuery(sql1);
                                                            if (rs.next()) {
                                                    %>
