...
<link rel="icon" href="../../../assets/images/favicon/3.png" type="image/x-icon">
    ...
    <body class="theme-color-1">
        ...
        <%
            ...
            try {
                String sql1 = "SELECT * FROM PRODCATEGORY WHERE PRODCATID = " + prodcatid;
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="page-title">
                            <h2><%= rs.getString("prodcatname")%></h2>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <nav aria-label="breadcrumb" class="theme-breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><%= rs.getString("prodcatname")%></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                        ...
                                        <div class="collection-product-wrapper">
                                            ...
                                            <div class="product-wrapper-grid">
                                                <div class="row margin-res">
                                                    <%
                                                        try {
                                                            String sql1 = "SELECT * FROM PRODUCTLIST WHERE PRODCATID = " + prodcatid + " AND PROD_STATUS = 'Active' AND ISDELETED =FALSE";
                                                            Statement stmt1 = conn.createStatement();
                                                            ResultSet rs = stmt1.executeQuery(sql1);
                                                            while (rs.next()) {
                                                                try {
                                                        ...
                                                        <div class="product-box">
                                                            <div class="img-wrapper">
                                                                ...
                                                                <div class="cart-info cart-wrap">
                                                                    ...
                                                                    <a href="#" onclick="addToWishlist(<%= rs.getInt("prodid")%>, <%=c.getCustID()%>)">
                                            ...
                                            <div class="product-pagination">
                                                <div class="theme-paggination-block">
                                                    <%
                                                        try {
                                                            String sql1 = "SELECT COUNT(*) as total FROM PRODUCTLIST WHERE PRODCATID = " + prodcatid + " AND PROD_STATUS = 'Active'";
                                                            Statement stmt1 = conn.createStatement();
                                                            ResultSet rs = stmt1.executeQuery(sql1);
                                                            if (rs.next()) {
                                                    %>
