<%-- 
    Document   : EditOrder
    Created on : Apr 30, 2023, 11:36:08 AM
    Author     : Rex Lim
--%>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="offset-xl-3 offset-sm-4 mt-4">
                                                                <!--                                                                <br/>
                                                                                                                                ...
                                                                                                                                <br/>
                                                                                                                                <br/>-->
                                                                <button type="submit" id="submitBtn" onclick="saveOrder(event)" class="btn btn-primary">Update</button>

                                                                <button  class="btn btn-light" id="discardButtonInPC" type="button" onclick="window.location = 'CurrentOrder.jsp'">Back</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="order-success">
                                                                    <div class="delivery-sec">
                                                                        ...
                                                                        <br>
                                                                        <h3>Status:<br>
                                                                            <select id="deliveryStatus" name="deliveryStatus" style="background-color: #f5f5f5; border: 1px solid #ccc; border-radius: 5px; padding: 5px; width: 60%">
                                                                        ...
                                                                        <br>
                                                                        <h3>Tracking No: <input type="text" id="trackingNo" name="trackingNo" placeholder="Enter Tracking No..." value="<%=o.getTrackingno()%>" style="background-color: #f5f5f5; border: 1px solid #ccc; border-radius: 5px; padding: 5px;">
                                                                        </h3>
                                                                    </div>
                                                                </div>
                                                            </div>      
...
//                    //Send JSON data to servlet using AJAX
                $.ajax({
                    type: "POST",
                    url: "/innisfree_1/editOrder", // Replace with your servlet URL
                    data: jsonData,
                    ...
                    success: function (response) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                window.location.replace("CurrentOrder.jsp");
                            }
                        })
                    },
