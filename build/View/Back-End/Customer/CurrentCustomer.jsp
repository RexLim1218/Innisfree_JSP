...
<html>
    ...
    <body>
        <%
            ...
            ArrayList<Customer> custList = dac.getAllCustomer();
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <ol class="breadcrumb pull-right">
                                        ...
                                        <li class="breadcrumb-item active">Current Customer</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive table-desi">
                                            <table  id="editableTable" class="orderTable">
                                                ...
                                                <tbody>
                                                    <%for (Customer cl : custList) {%>

                                                    <tr>
                                                        <td data-field="username"><%=cl.getCustUsername()%></td>

                                                        <td data-field="fullname"><%=cl.getCustName()%></td>
                                                        <td data-field="email"><%=cl.getCustEmail()%></td>

                                                        <td data-field="phoneNum"><%=cl.getCustHP()%></td>

                                                        <%

                                                            if (cl.getCust_Status().equals("Active")) {%>

                                                        <td class="order-success" data-field="emp_Status">
                                                            <span><%=cl.getCust_Status()%></span>
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="ViewCustomer.jsp?custID=<%=cl.getCustID()%>" id="viewBtn" class="prodCatView" role="button" style="margin-right: 10px;">
                                                            ...
                                                            <%
                                                                  ...
                                                                  if (cl.getCust_Status().equals("Active")) {%>
                                                            <a onclick="deactiveConfimation(<%=cl.getCustID()%>, '<%=cl.getCustUsername()%>')" id="viewBtn" class="prodCatView" role="button" style="margin-right: 10px;">
                                                                <i class="fa fa-times fa-lg" title="Deactive"></i>
                                                            </a>


                                                            <%} else {%>
                                                            <a onclick="activeConfimation(<%=cl.getCustID()%>, '<%=cl.getCustUsername()%>')" id="viewBtn" class="prodCatView" role="button" style="margin-right: 10px;">
