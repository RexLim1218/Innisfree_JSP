    ...
    <body>
                        ...
                        <div class="col-md-5 p-0 card-left">
                            <div class="card bg-primary">
                                ...
                                <div class="single-item">
                                    <div>
                                        <div>
                                            <h3>Innisfree Admin Panel</h3><br>
                                            <h3>Welcome Back !</h3>
                                            <p>To Login Innisfree Admin Panel , please login with your personal info.</p>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content" id="top-tabContent">
                                        <div class="tab-pane fade show active" id="top-profile" role="tabpanel"
                                            ...
                                            <form class="form-horizontal auth-form" action="${pageContext.servletContext.contextPath}/UserLogin" method="post">
                                                <div class="form-group">
                                                    <input required="" name="empUsername" type="text"
                                                           class="form-control" placeholder="Username" id="empUsername">
                                                </div>
                                                <div class="form-group">
                                                    <input required="" name="empPwd" type="password"
                                                           class="form-control" placeholder="Password" id="empPwd">
                                                    <i class="far fa-eye" id="togglePassword" style="position: relative; left: 420px; top: -35px;  cursor: pointer;"></i>

                                                </div>
                                                <script>
                                                    const togglePassword = document.querySelector('#togglePassword');
                                                    const password = document.querySelector('#empPwd');
                                                ...
                                                <div class="form-button">
                                                    <button class="btn btn-primary" type="submit" onclick="submitLogin(event)">Login</button>
                                                </div>
                                                <div>
                                                    <span></span>
                                                    <div>
        ...
        <script>
            function submitLogin(event) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/innisfree_1/UserLogin", // Replace with your servlet URL
                    data: jsonData,
                        ...
                        if (response.status === "success") {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    window.location.replace("Dashboard/Dashboard.jsp");
                                }
                            })
